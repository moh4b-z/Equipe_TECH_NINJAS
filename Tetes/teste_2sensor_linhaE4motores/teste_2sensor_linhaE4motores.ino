...
void moveRight() {
  // Curva para a direita (motores do lado esquerdo para frente, motores do lado direito para trás)
  digitalWrite(motor1Pin1, HIGH);
  digitalWrite(motor1Pin2, LOW);
  digitalWrite(motor2Pin1, HIGH);
  digitalWrite(motor2Pin2, LOW);
...
void moveLeft() {
  // Curva para a esquerda (motores do lado direito para frente, motores do lado esquerdo para trás)
